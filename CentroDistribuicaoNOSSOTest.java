...
public class CentroDistribuicaoNOSSOTest{
    @Test
    public void alcoolValido(){
        CentroDistribuicaoNOSSO centroDistribuicao = new CentroDistribuicaoNOSSO(5,70,12,12);
        assertEquals(centroDistribuicao.gettAlcool1(), centroDistribuicao.gettAlcool2());
    }

    @Test
    public void alcoolInvalido(){
        assertThrows(IllegalArgumentException.class, () -> new CentroDistribuicaoNOSSO(5,70,11,10));
    }
    @Test
    ...
    public void limitesGasolina(int input, int ad, int gas, int al1, int al2, int situacao){
        CentroDistribuicaoNOSSO cd = new CentroDistribuicaoNOSSO(ad, gas, al1, al2);
    ...
    public void encomendas(int input, int ad, int gas, int al1, int tipoposto, int adres, int gasres, int alres){
        CentroDistribuicaoNOSSO cd = new CentroDistribuicaoNOSSO(ad, gas, al1, al1);
        int[] aux;
        if(tipoposto==1) aux = cd.encomendaCombustivel(input, CentroDistribuicaoNOSSO.TIPOPOSTO.COMUM);
        else aux = cd.encomendaCombustivel(input, CentroDistribuicaoNOSSO.TIPOPOSTO.ESTRATEGICO);
        if(adres<0){
    ...
    public void tanquecheioGas(){
        CentroDistribuicaoNOSSO cd = new CentroDistribuicaoNOSSO(1, 5000, 1, 1);
        int res = cd.recebeGasolina(50000000);
        assertEquals(5000, res);
    }
    @Test
    public void tanquecheioAlcool(){
        CentroDistribuicaoNOSSO cd = new CentroDistribuicaoNOSSO(1, 1, 1000, 1000);
    ...
    public void tanquecheioAditivo(){
        CentroDistribuicaoNOSSO cd = new CentroDistribuicaoNOSSO(400, 1, 1, 1);
    ...
    @Test
    public void nse(){
        CentroDistribuicaoNOSSO cd = new CentroDistribuicaoNOSSO(500, 10000, 1250, 1250);
        cd.encomendaCombustivel(6000, CentroDistribuicaoNOSSO.TIPOPOSTO.ESTRATEGICO);
        assertEquals(CentroDistribuicaoNOSSO.SITUACAO.SOBRAVISO, cd.getSituacao());
        cd.encomendaCombustivel(2500, CentroDistribuicaoNOSSO.TIPOPOSTO.ESTRATEGICO);
        assertEquals(CentroDistribuicaoNOSSO.SITUACAO.EMERGENCIA, cd.getSituacao());
    }

    @Test
    public void nsn(){
        CentroDistribuicaoNOSSO cd = new CentroDistribuicaoNOSSO(500, 10000, 1250, 1250);
        cd.encomendaCombustivel(6000, CentroDistribuicaoNOSSO.TIPOPOSTO.COMUM);
        assertEquals(CentroDistribuicaoNOSSO.SITUACAO.SOBRAVISO, cd.getSituacao());
        cd.recebeAditivo(300);
        cd.recebeGasolina(200);
        cd.recebeAlcool(2000);
        assertEquals(CentroDistribuicaoNOSSO.SITUACAO.NORMAL, cd.getSituacao());
    }

    @Test
    public void nes(){
        CentroDistribuicaoNOSSO cd = new CentroDistribuicaoNOSSO(500, 10000, 1250, 1250);
        cd.encomendaCombustivel(10000, CentroDistribuicaoNOSSO.TIPOPOSTO.COMUM);
        assertEquals(CentroDistribuicaoNOSSO.SITUACAO.EMERGENCIA, cd.getSituacao());
